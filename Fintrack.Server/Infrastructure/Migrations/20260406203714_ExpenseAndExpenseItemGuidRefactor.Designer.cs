...
namespace Fintrack.Server.Migrations
{
    ...
    [Migration("20260406203714_ExpenseAndExpenseItemGuidRefactor")]
    partial class ExpenseAndExpenseItemGuidRefactor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fintrack.Server.Domain.Incomes.IncomeCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Fintrack.Server.Domain.Incomes.Income", b =>
                {
                    b.HasOne("Fintrack.Server.Domain.Incomes.IncomeCategory", "Category")
                        .WithMany("Incomes")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
