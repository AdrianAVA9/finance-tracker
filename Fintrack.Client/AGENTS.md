...
- **Mobile Safeties:** Always respect device safe areas. Use custom utilities like `pb-safe` on main wrappers or navbars to prevent critical UI from hiding behind modern iOS Home indicators.
