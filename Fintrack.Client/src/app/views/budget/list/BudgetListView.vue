...
<template>
  <div class="space-y-6">
    ...
    <section class="grid grid-cols-1 gap-4">
      <SurfaceCard class="relative overflow-hidden transition-all duration-500">
    ...
    <section v-if="budgets.length > 0">
      <SurfaceCard
        class="flex items-start gap-4 transition-all hover:bg-surface-container-high shadow-sm shadow-primary/5 !bg-surface-container-high/50 !border-white/5 !rounded-2xl"
      >
